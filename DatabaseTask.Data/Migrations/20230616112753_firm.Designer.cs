...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.Campain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.Email", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.Issue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.Offer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.OrderSending", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.SalesOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.Employee", b =>
                {
                    b.HasOne("DatabaseTask.Core.Domain.Email", "Email")
                        .WithMany()
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.Issue", b =>
                {
                    b.HasOne("DatabaseTask.Core.Domain.Offer", "Offer")
                        .WithMany("Issues")
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.Offer", b =>
                {
                    b.HasOne("DatabaseTask.Core.Domain.Client", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("DatabaseTask.Core.Domain.OrderSending", b =>
                {
                    ...
                    b.HasOne("DatabaseTask.Core.Domain.SalesOrder", "SalesOrder")
                        .WithMany("OrderSending")
